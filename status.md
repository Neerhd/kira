...
## Project overview
Kira is Neerh's personal design system —
built with a distinct personality, in public,
usable by others. First real project in the
build-without-engineers stack.

## Milestones
- [x] v0.1 — token architecture, 8 components,
      docs site, Figma variables
- [ ] v0.2 — polish, resolved token values,
      docs site uses own tokens
- [ ] npm publish kira-ui
- [ ] Personal site rebuild using Kira
